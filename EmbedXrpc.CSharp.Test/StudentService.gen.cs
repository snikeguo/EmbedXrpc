...
// auto code gen ! DO NOT modify this file! create time 2020-04-15 23:56:54.900 ; 
namespace StudentService
{
    ...
    public class BroadcastDataTimeDelegate
    {
        ...
        public void Invoke(DateTime_t t)
        {
            ...
            sendBytes.Add((byte)(BroadcastDataTime_ServiceId >> 16 & 0xff));
            sendBytes.Add((byte)(BroadcastDataTime_ServiceId >> 24 & 0xff));
    ...
    public class IMyInterfaceClientImpl
    {
        ...
        public GetStudentInfoFormStudentId_Response GetStudentInfoFormStudentId(Byte StudentIdLen, Byte[] StudentId, Int32 arg2, Int32 arg3)
        {
            lock (Client.ObjectMutex)
            {
                ...
                sendBytes.Add((byte)(GetStudentInfoFormStudentId_ServiceId >> 16 & 0xff));
                sendBytes.Add((byte)(GetStudentInfoFormStudentId_ServiceId >> 24 & 0xff));
                sendBytes.AddRange(sm.Data);
        ...
        public GetStudentsInfoFormAge_Response GetStudentsInfoFormAge()
        {
            lock (Client.ObjectMutex)
            {
                ...
                sendBytes.Add((byte)(GetStudentsInfoFormAge_ServiceId >> 16 & 0xff));
                sendBytes.Add((byte)(GetStudentsInfoFormAge_ServiceId >> 24 & 0xff));
                sendBytes.AddRange(sm.Data);
                Client.Send(sendBytes.Count, 0, sendBytes.ToArray());
        ...
        public void Test()
        {
            lock (Client.ObjectMutex)
            {
                ...
                sendBytes.Add((byte)(Test_ServiceId >> 16 & 0xff));
                sendBytes.Add((byte)(Test_ServiceId >> 24 & 0xff));
                sendBytes.AddRange(sm.Data);
                Client.Send(sendBytes.Count, 0, sendBytes.ToArray());
            }
        }
