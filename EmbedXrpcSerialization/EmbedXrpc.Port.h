...
public:
	...
	virtual QueueState ReceiveQueue(EmbeXrpc_Semaphore_t sem, void * item,uint32_t itemlen,uint32_t timeout) = 0;
	virtual QueueState SendQueue(EmbeXrpc_Semaphore_t sem, void* item, uint32_t itemlen) = 0;
