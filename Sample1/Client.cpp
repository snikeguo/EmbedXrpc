...
DelegateDescribe<UserDataOfTransportLayer_t> AllDelegates[2] =//定义委托对象集合
{
...
EmbedXrpcObject<UserDataOfTransportLayer_t> ClientRpc(&InitConfig);//client rpc 对象


InterClientImpl<UserDataOfTransportLayer_t> Client(&ClientRpc);//定义request对象
void ClientThread()
{
