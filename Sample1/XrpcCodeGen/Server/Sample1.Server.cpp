...
sm.Serialize(&DateTimeChange_Parameter_TypeInstance,&sendData,0);
...
recManager.Deserialize(&Inter_Add_Parameter_TypeInstance,&request);
...
SerializationManager::FreeData(&Inter_Add_Parameter_TypeInstance,&request);
sendManager.Serialize(&Inter_Add_Return_TypeInstance,&Response,0);
...
recManager.Deserialize(&Inter_NoArg_Parameter_TypeInstance,&request);
#if EmbedXrpc_UseRingBufferWhenReceiving==1
EmbedSerializationAssert(recManager.BlockBufferProvider->GetReferenceSum()==recManager.BlockBufferProvider->GetCalculateSum());
#else
EmbedSerializationAssert(recManager.ReferenceSum==recManager.CalculateSum);
#endif
NoArg();
SerializationManager::FreeData(&Inter_NoArg_Parameter_TypeInstance,&request);
sendManager.Serialize(&Inter_NoArg_Return_TypeInstance,&Response,0);
...
recManager.Deserialize(&Inter_NoReturn_Parameter_TypeInstance,&request);
#if EmbedXrpc_UseRingBufferWhenReceiving==1
EmbedSerializationAssert(recManager.BlockBufferProvider->GetReferenceSum()==recManager.BlockBufferProvider->GetCalculateSum());
#else
EmbedSerializationAssert(recManager.ReferenceSum==recManager.CalculateSum);
#endif
NoReturn(request.a);
SerializationManager::FreeData(&Inter_NoReturn_Parameter_TypeInstance,&request);
}
...
recManager.Deserialize(&Inter_NoArgAndReturn_Parameter_TypeInstance,&request);
#if EmbedXrpc_UseRingBufferWhenReceiving==1
EmbedSerializationAssert(recManager.BlockBufferProvider->GetReferenceSum()==recManager.BlockBufferProvider->GetCalculateSum());
#else
EmbedSerializationAssert(recManager.ReferenceSum==recManager.CalculateSum);
#endif
NoArgAndReturn();
SerializationManager::FreeData(&Inter_NoArgAndReturn_Parameter_TypeInstance,&request);
}
