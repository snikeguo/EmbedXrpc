...
public:
  ...
  GetStudentInfoFormStudentId_Response &GetStudentInfoFormStudentId(Byte StudentIdLen, Byte StudentId[100], Int32 arg2, Int32 arg3)
  {
    ...
    RpcClientObject->Buffer[2] = (uint8_t)(GetStudentInfoFormStudentId_ServiceId >> 16 & 0xff);
    RpcClientObject->Buffer[3] = (uint8_t)(GetStudentInfoFormStudentId_ServiceId >> 24 & 0xff);
  ...
  GetStudentsInfoFormAge_Response &GetStudentsInfoFormAge()
  {
    ...
    RpcClientObject->Buffer[2] = (uint8_t)(GetStudentsInfoFormAge_ServiceId >> 16 & 0xff);
    RpcClientObject->Buffer[3] = (uint8_t)(GetStudentsInfoFormAge_ServiceId >> 24 & 0xff);
    RpcClientObject->Send(RpcClientObject, sm.Index + 4, RpcClientObject->Buffer);
    sm.Reset();
  ...
  void Test()
  {
    ...
    RpcClientObject->Buffer[2] = (uint8_t)(Test_ServiceId >> 16 & 0xff);
    RpcClientObject->Buffer[3] = (uint8_t)(Test_ServiceId >> 24 & 0xff);
    RpcClientObject->Send(RpcClientObject, sm.Index + 4, RpcClientObject->Buffer);
    sm.Reset();
    RpcClientObject->porter->ReleaseMutex(RpcClientObject->ObjectMutexHandle);
  }
};
extern ResponseDelegateMessageMap IMyInterface_ResponseDelegateMessages[3];
